...
final class MoviesStructTests: XCTestCase {
    ...
    func testEquatable_ReturnsNotEqualForDifferentReleaseDates(){
        let actionMovie1 = Movie(title: "Action",releasedYear: "1999")
        let actionMovie2 = Movie(title: "Adventure",releasedYear: "2018")
        XCTAssertNotEqual(actionMovie1, actionMovie2)
    }
